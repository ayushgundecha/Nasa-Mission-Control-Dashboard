...
export const orbitalObjectSchema = z
  .object({
    ...
    rightAscensionOfAscendingNode: quantitySchema,
    argumentOfPerigee: quantitySchema,
    meanAnomaly: quantitySchema,
    bstar: quantitySchema,
    meanMotionDot: quantitySchema,
    meanMotionDdot: quantitySchema,
    elementSetNumber: quantitySchema,
    revolutionNumberAtEpoch: quantitySchema,
...
export const nearEarthApproachSchema = z
  .object({
    ...
    closeApproachJulianDate: quantitySchema,
    closeApproachTimeScale: z.literal("TDB"),
    timeConversionMethod: z.string().min(1).max(240),
    nominalDistance: quantitySchema,
    minimumDistance: quantitySchema.nullable(),
    maximumDistance: quantitySchema.nullable(),
    nominalDistanceLunar: quantitySchema,
    minimumDistanceLunar: quantitySchema.nullable(),
    maximumDistanceLunar: quantitySchema.nullable(),
    relativeVelocity: quantitySchema,
    absoluteMagnitude: quantitySchema.nullable(),
    diameter: quantitySchema.nullable(),
    closeApproachTimeUncertainty: z.string().min(1).max(32).nullable(),
    orbitId: z.string().min(1).max(80),
