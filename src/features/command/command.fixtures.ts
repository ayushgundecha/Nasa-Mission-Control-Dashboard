...
export const orbitalObjectFixture = orbitalObjectSchema.parse({
  ...
  rightAscensionOfAscendingNode: observedQuantity(
    30.2,
    "degrees",
    celestrakSource,
  ),
  argumentOfPerigee: observedQuantity(120.4, "degrees", celestrakSource),
  meanAnomaly: observedQuantity(240.6, "degrees", celestrakSource),
  bstar: observedQuantity(0.0002, "unitless", celestrakSource),
  meanMotionDot: observedQuantity(0.0001, "unitless", celestrakSource),
  meanMotionDdot: observedQuantity(0, "unitless", celestrakSource),
  elementSetNumber: observedQuantity(999, "count", celestrakSource),
  revolutionNumberAtEpoch: observedQuantity(54321, "count", celestrakSource),
...
export const approachFixture = nearEarthApproachSchema.parse({
  ...
  closeApproachJulianDate: {
    ...observedQuantity(2461291.972, "julian_date", jplSource),
    evidenceClass: "authoritative_computed",
  },
  closeApproachTimeScale: "TDB",
  timeConversionMethod:
    "Fixture UTC derived from JPL TDB using the AstraOps TDB-to-UTC conversion.",
  nominalDistance: {
  ...
  nominalDistanceLunar: {
    ...
    source: null,
    method: "Fixture AU-to-lunar-distance conversion.",
  },
  minimumDistanceLunar: null,
  maximumDistanceLunar: null,
  relativeVelocity: {
  ...
  diameter: null,
  closeApproachTimeUncertainty: null,
  orbitId: "fixture-orbit-1",
